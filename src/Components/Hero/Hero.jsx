...
const Hero = ({handleorderPoppup}) => {
  ...
  return (
    <div
      className="relative overflow-hidden min-h-[550px] sm:m-h-[650px] bg-gray-100 flex justify-center items-center
            ...
            <div key={data.id}>
              <div className="grid grid-cols-1 sm:grid-cols-2">
                ...
                >
                  ...
                  data-aos-duration= "500"
                  data-aos-delay= "300">
                    <button className="bg-gradient-to-r from-primary to-secondary hover:scale-105 duration-200 rounded-full text-white py-2 px-4"
