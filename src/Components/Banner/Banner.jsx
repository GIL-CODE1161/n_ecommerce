        ...
        <div className='container'>
            <div className='grid grid-cols-1 sm:grid-cols-2 gap-6 items-center '>
                ...
                <div className='flex flex-col justify-center gap-6  sm:pt-0'>
                    ...
                    <p data-aos="fade-up" className='text-sm text-gray-500 tracking-wide leading-5'>Lorem ipsum dolor sit, amet consectetur adipisicing elit.
                        Molestiae, beatae, 
                        cum ducimus velit nulla, officia esse id ipsa possimus eveniet dignissimos 
                        ullam assumenda neque voluptatem placeat animi unde minus nobis?
                        </p>
                        <div className="flex flex-col gap-4">
                            ...
                            bg-green-100 dark:bg-green-400 rounded-full'/>
                                <p>Easy Payment Method</p>
                            </div>
                            <div data-aos="fade-up"className='flex items-center gap-4 '>
                                <GiFoodTruck className='text-4xl h-12 w-12 shadow-sm p-4 
                            bg-yellow-100 dark:bg-yellow-400 rounded-full'/>
                                <p>Get Offers</p>
                            </div>
                        </div>
                </div>
